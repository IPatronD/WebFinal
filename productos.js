document.addEventListener('DOMContentLoaded', () => {
    ...
    // Add visible class to footer to show it
    ...
    const products = [
        ...
        { name: "Estilógrafo Unipin 0.8", price: 6.80, category: "Lapices de dibujo, carboncillo, pasteles", img: "ImgProductos/Estilografo UNIPIN 0.8.webp" },
        { name: "Estilógrafo Unipin 0.5", price: 6.80, category: "Lapices de dibujo, carboncillo, pasteles", img: "ImgProductos/Estilografo UNIPIN 0.5.webp" },
        { name: "Estilógrafo Unipin 0.3", price: 6.80, category: "Lapices de dibujo, carboncillo, pasteles", img: "ImgProductos/Estilografo UNIPIN 0.3.webp" },
        { name: "Estilógrafo Artline 0.8", price: 8.50, category: "Lapices de dibujo, carboncillo, pasteles", img: "ImgProductos/Estilografo ARTLINE 0.8.webp" },
        { name: "Estilógrafo Artline 0.5", price: 8.50, category: "Lapices de dibujo, carboncillo, pasteles", img: "ImgProductos/Estilografo ARTLINE 0.5.webp" },
        { name: "Estilógrafo Artline 0.3", price: 8.50, category: "Lapices de dibujo, carboncillo, pasteles", img: "ImgProductos/Estilografo ARTLINE 0.3.webp" },
        ...
        { name: "Compás escolar Layconsa plastico con lapiz", price: 2.20, category: "Regla T, compás, transportador", img: "ImgProductos/compás escolar layconsa plástico c lapiz.webp" },
        { name: "Lapiz 2B Artesco", price: 0.50, category: "Lápices y Lapiceros", img: "ImgProductos/lapiz 2b artesco.webp" },
        { name: "Lapiz de chequeo rojo Artesco", price: 0.80, category: "Lápices y Lapiceros", img: "ImgProductos/lapiz chequeo rojo artesco.webp" },
        { name: "Lapiz Faber-Castell profesional 2B", price: 2.10, category: "Lápices y Lapiceros", img: "ImgProductos/LAPIZ FC PROF 2B.webp" },
        { name: "Lapiz Faber-Castell profesional 2H", price: 2.10, category: "Lápices y Lapiceros", img: "ImgProductos/LAPIZ FC PROF 2H.webp" },
  ...
  `;
    ...
    function addToCart(product, quantity) {
        ...
        if (existingItem) {
            ...
            cartItems.push({ name: product.name, quantity: quantity, price: product.price, image: product.img });
        }
        renderCart();
    ...
    const productosPorPagina = 12; // Cambia este número según cuántos productos mostrar por página
    let paginaActual = 1;

    const tabsContainer = document.createElement('div');
    tabsContainer.id = 'product-tabs';
    tabsContainer.className = 'mb-6 flex flex-wrap gap-2 justify-center';
    elements.productsGrid.parentNode.insertBefore(tabsContainer, elements.productsGrid);

    function renderProductsPaginados() {
        const inicio = (paginaActual - 1) * productosPorPagina;
        const fin = inicio + productosPorPagina;
        const productosPagina = products.slice(inicio, fin);
        renderProducts(productosPagina);
    }
    ...
    function renderTabs() {
        ...
        for (let i = 1; i <= totalPaginas; i++) {
            ...
            btn.className = 'tab-btn' + (i === paginaActual ? ' active' : '');
            btn.textContent = i;
            btn.addEventListener('click', () => {
                paginaActual = i;
                renderProductsPaginados();
                renderTabs();
            });
